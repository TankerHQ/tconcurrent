...
/** Make a sender that runs \p sender and map its result to \p fun.
 */
template <typename Sender, typename F>
...
/** Make a sender that runs \p sender and give its result and a receiver to \p
 * fun.
 *
 * \p fun's return type is ignored, its first argument will be a receiver that
...
/** Make a sender that runs \p sender1 and give its result to \p sender2.
 */
template <typename Sender1, typename Sender2>
